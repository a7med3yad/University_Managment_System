...
public class Delete_staff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        inst_id.setText("Enter Intsructor's ID");
...
// Validate and parse department ID
        try {
              instructor_id = Integer.parseInt(inst_id.getText());
...
// Database operation
        try (Connection connection = ConnectToDB.getConnection(); java.sql.PreparedStatement preparedStatement = connection.prepareStatement(
            ...
            if (rowsAffected > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Failed to delete the Instructor. Please try again.");
            }
